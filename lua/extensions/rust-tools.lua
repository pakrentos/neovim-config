...
local opts = {
    ...
    server = {
        ...
        --     -- vim.api.nvim_create_user_command('RustToolsHoverActions',function(opts)
        --     --   pcall(rt.hover_actions.hover_actions, opts))
        --     -- end, bufnr)
        --     --
        --     -- vim.api.nvim_create_user_command('RustToolsCodeActionGroup',function(opts)
        --     --   pcall(rt.hover_actions.hover_actions, opts))
        --     -- end, bufnr)
        --   -- Hover actions
